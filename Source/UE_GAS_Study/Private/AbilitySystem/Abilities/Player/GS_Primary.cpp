...
TArray<AActor*> UGS_Primary::HitBoxOverlapTest()
{
	...
	GetWorld()->OverlapMultiByChannel(OverlapResults, HitBoxLocation, FQuat::Identity, ECC_Visibility, Sphare, QueryParams, ResponseParams);
...
void UGS_Primary::DrawHitBoxOverlapDebugs(const TArray<FOverlapResult>& OverlapResults, const FVector& HitBoxLocation) const
{
